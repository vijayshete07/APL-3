...
public class Page3 extends AppCompatActivity {
    ...
    private Button page1Button, page5Button, page2Button, page4Button;
    ...
    private void openPage(int pageNumber) {
        ...
        switch (pageNumber) {
            ...
            case 1:
                intent = new Intent(Page3.this, Page1.class);
                break;
            case 2:
                intent = new Intent(Page3.this, Page2.class);
                break;
            case 4:
                intent = new Intent(Page3.this, Page4.class);
                break;
            case 5:
                intent = new Intent(Page3.this, Page5.class);
                break;
            default:
                return;
        }
