...
public class Page1 extends AppCompatActivity {
    ...
    private Button page2Button, page5Button, page3Button, page4Button;
    ...
    private void openPage(int pageNumber) {
        ...
        switch (pageNumber) {
            ...
            case 2:
                ...
                break;
            case 3:
                intent = new Intent(Page1.this, Page3.class);
                break;
            case 4:
                intent = new Intent(Page1.this, Page4.class);
                break;
            case 5:
                intent = new Intent(Page1.this, Page5.class);
                break;
            default:
                return;
        }
